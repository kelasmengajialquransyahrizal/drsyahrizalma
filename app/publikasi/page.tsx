        ...
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 md:p-12">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center mb-10 pb-6 border-b border-gray-100">
            ...
            <div className="w-full md:w-auto mt-4 md:mt-0 flex space-x-2">
              <button className="px-3 py-1.5 bg-emerald/10 text-emerald-dark text-sm rounded-md font-medium">Semua</button>
            ...
            {publications.map((pub) => (
              <div key={pub.id} className="group pb-8 border-b border-gray-50 last:border-0 last:pb-0">
                <div className="flex items-start">
                  <div className="mt-1 bg-gray-100 text-emerald-dark p-2 rounded-lg mr-4 group-hover:bg-emerald group-hover:text-white transition-colors shrink-0">
                    <FileText size={24} />
                  </div>
                  <div>
                    <span className="inline-block px-2 py-1 bg-emerald/5 text-emerald text-xs font-bold rounded mb-2">
                      {pub.type} • {pub.year}
                    </span>
                    ...
                    <div className="flex flex-wrap gap-3">
                      ...
                      <a href={pub.link} className="flex items-center text-xs font-semibold text-emerald hover:text-emerald-dark transition-colors">
