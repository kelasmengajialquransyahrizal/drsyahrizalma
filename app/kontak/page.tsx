      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="bg-blue/10 text-blue p-3 rounded-full mr-4 shrink-0">
                    <MapPin size={24} />
                  </div>
                  <div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href={`https://wa.me/${siteConfig.contact.phone.replace(/[^0-9]/g, '')}`} target="_blank" rel="noreferrer" className="text-blue text-sm font-medium hover:underline mt-1 inline-block">
            ...
            <div className="bg-blue-dark text-white p-8 rounded-3xl shadow-lg relative overflow-hidden">
                <div className="relative z-10">
                  <h3 className="text-2xl font-bold mb-4">Konsultasi Privat</h3>
                  <p className="text-blue-light mb-6 opacity-90">Sesi 1-on-1 via Zoom/GMeet membahas isu strategis institusi atau riset Anda.</p>
          ...
          <div className="lg:col-span-7">
            <div className="bg-white p-8 md:p-10 rounded-3xl shadow-xl border border-gray-100 relative">
              ...
              <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="pt-4">
                  <button type="submit" className="w-full py-4 bg-blue text-white font-bold rounded-xl hover:bg-blue-dark transition-all flex items-center justify-center shadow-lg shadow-blue/20">
